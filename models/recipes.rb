...
@recipes = {
  :vegan => {:donuts=>{
            ...
            :rigatoni => {
              ...
              :buhda_bowl => {
                :title=>"Vegan Buhda Bowl",
                :link=>"http://minimalistbaker.com/sweet-potato-chickpea-buddha-bowl/",
                :picture=>"#",
                :content=>"This is a vegan, gluten-free and vegetarian buhda bowl that is medium difficulty."},
              :smoothie => {
                :title=>"Protien smoothie",
                :link=>"http://www.popsugar.com/fitness/Blackberry-Breakfast-Smoothie-34773636",
                :picture=>"#",
                :content=>"This is a vegan and gluten-free smoothie that is easy difficulty."},
            },
  :vegetarian => {:panini => {
